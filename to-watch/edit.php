...
<?php
  ...
  if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM `to_watch` WHERE id = $id";
...
<body class='bg-black'>
    ...
    <div class="container py-5">
        <div class="modal-body text-white w-50 mx-auto">
            <!-- the form -->
            <form method="POST" action="../to-watch.php?id=<?php echo $id; ?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="day" value='<?php if(isset($_GET['id'])) { echo $day; } ?>'  class="form-control bg-black text-white" id="recipient-name">
                </div>
                <!-- <div class="mb-3">
